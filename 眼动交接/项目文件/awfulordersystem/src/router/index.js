            ...
            children : [
              {
                ...
                name : 'SelectSpace',
                component : () => import('../views/expr/MyLearning/Booking/SelectSpace.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectDate',
                name : 'SelectDate',
                component : () => import('../views/expr/MyLearning/Booking/SelectDate.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectDateConsistency',
                name : 'SelectDateConsistency',
                component : () => import('../views/expr/MyLearning/Booking/SelectDateConsistency.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectDateEaseOfUse',
                name : 'SelectDateEaseOfUse',
                component : () => import('../views/expr/MyLearning/Booking/SelectDateEaseOfUse.vue')
              },
              {
                path : '/expr/MyLearning/Booking/Confirm',
                name : 'Confirm',
                component : () => import('../views/expr/MyLearning/Booking/Confirm.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectSeat',
                name : 'SelectSeat',
                component : () => import('../views/expr/MyLearning/Booking/SelectSeat.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectSeatRobustness',
                name : 'SelectSeatRobustness',
                component : () => import('../views/expr/MyLearning/Booking/SelectSeatRobustness.vue')
              },
              {
                path : '/expr/MyLearning/Booking/SelectSeatDeviceEfficiency',
                name : 'SelectSeatDeviceEfficiency',
                component : () => import('../views/expr/MyLearning/Booking/SelectSeatDeviceEfficiency.vue')
              }
            ]
          },
          {
...
function scanChildNode(node, path){
  ...
  try {
    ...
    elementsPosition[path] = {"x1": left, "y1": top, "x2": left + node.offsetWidth, "y2": top + node.offsetHeight}
  } catch(e){
    return
  }
  ...
  for(let i = 0; i < childNodes.length; i++){
    ...
    if (childNodes[i].nodeType === 1)
      scanChildNode(childNodes[i], childPath)
  }
}

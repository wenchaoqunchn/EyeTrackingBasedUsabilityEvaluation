...
export default {
  ...
  methods: {
    link(e, id) {
      ...
      if (
        !(
          e.clientX > postion["x_min"] &&
          e.clientX < postion["x_max"] &&
          e.clientY > postion["y_min"] &&
          e.clientY < postion["y_max"]
        )
      ) {
        return;
      }
    ...
    getPosition(element) {
      ...
      return {
        x_min: left + padding,
        y_min: top + padding,
        x_max: left + element.offsetWidth - padding,
        y_max: top + element.offsetHeight - padding,
      };
    },
  },
};
